...
| Project7 | `detail-pages/Project7/` | `public/content/projects/project-7-{en,zh,ua}.json` | `public/images/projects/project-7/` |
...
| `file-validation.ts`             | `validateMediaFiles()`, `MAX_MEDIA_FILE_SIZE`, `MIME_TO_EXT`                                | 上传文件类型/大小校验（共用）       |
