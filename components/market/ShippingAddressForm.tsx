  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <h3 className="text-sm font-semibold tracking-wide text-gray-600">{t('title')}</h3>
      </div>

      {/* ① Country — first, sets context */}
      <div>
        <label className="mb-1.5 block text-[13px] font-medium text-gray-500">{t('country')}</label>
        <CountrySelect
          value={value.country}
      ...
      {hasCountry && (
        <div className="mkt-step-in space-y-4">
          {/* ② Name */}
          <div>
          ...
          <div>
            ...
            {errors?.address_line1 && (
              <p className="mt-1.5 text-xs text-warm-600">{errors.address_line1}</p>
            )}
          </div>
          ...
          <div className="sm:w-1/2">
            ...
            />
            {errors?.postal_code && (
              <p className="mt-1.5 text-xs text-warm-600">{errors.postal_code}</p>
            )}
          </div>
        </div>
      )}
