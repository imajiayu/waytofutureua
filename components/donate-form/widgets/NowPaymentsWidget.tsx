...
import { formatCountdown } from '@/lib/payment/format-countdown'
import type { CreatePaymentResponse } from '@/lib/payment/nowpayments/types'

import CryptoStatusIndicator from './CryptoStatusIndicator'
...
export default function NowPaymentsWidget({
  ...
  return (
    <div className="space-y-5 p-6">
      ...
      {/* Status Indicator */}
      <CryptoStatusIndicator status={currentStatus} />
