...
export const marketOrderPaidContent: Record<Locale, MarketOrderPaidContent> = {
  en: {
    ...
    nextStepsContent:
      'We will prepare your item and notify you by email once it has been shipped. You can check your order status at any time.',
  ...
  ua: {
    ...
    nextStepsContent:
      'Ми підготуємо ваш товар і повідомимо вас електронною поштою, коли він буде відправлений. Ви можете перевірити статус замовлення в будь-який час.',
