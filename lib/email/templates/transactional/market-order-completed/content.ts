...
export const marketOrderCompletedContent: Record<Locale, MarketOrderCompletedContent> = {
  en: {
    subject: (orderRef: string) => `Your Order ${orderRef} is Complete!`,
    title: 'Order Complete!',
    greeting: (name: string) => `Dear ${name},`,
    congratulations: '🎉 Thank You!',
    completedMessage: 'Your charity market order has been completed. The funds from your purchase have been used to support our humanitarian mission.',
    impactMessage: 'Your purchase directly contributes to humanitarian aid in Ukraine. Every order makes a real difference.',
    ...
    shareContent: 'We encourage you to share our charity market with friends and family to help us reach more people in need.',
    gratitude: 'We are deeply grateful for your support through our charity market. Together, we are building a better future.',
  ...
  ua: {
    ...
    completedMessage: 'Ваше замовлення на благодійному ярмарку завершено. Кошти від вашої покупки використані для підтримки нашої гуманітарної місії.',
    impactMessage: 'Ваша покупка безпосередньо сприяє гуманітарній допомозі в Україні. Кожне замовлення має реальне значення.',
    ...
    shareContent: 'Ми заохочуємо вас поділитися нашим благодійним ярмарком з друзями та родиною, щоб допомогти нам охопити більше людей, які потребують допомоги.',
    gratitude: 'Ми глибоко вдячні за вашу підтримку через наш благодійний ярмарок. Разом ми будуємо краще майбутнє.',
